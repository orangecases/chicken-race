...
const chicken = {
    ...
    cutJump() {
        ...
        // [수정] 모바일 탭(짧은 터치) 시 점프가 너무 낮아 보이는 문제를 개선하기 위해 최소 상승 속도를 대폭 상향 (-15 -> -25)
        // 사용자가 -20으로도 부족하다고 느꼈으므로, 초기 점프력(-30)에 가까운 -25로 설정하여 최소 점프 높이를 보장합니다.
        if (this.dy < -25) { this.dy = -25; }
    }
};
